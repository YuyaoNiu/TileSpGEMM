...
void step3_cuda (int *blkrowptrA, int *blkcolidxA, int blkmA, int blknA, int numblkA, int nnzA, int *nnzb_A ,int mA,
            ...
            int *nnzb_C_golden,  int numblkC, int *nnzC, int *d_blksmem_tny_cnt, int *d_blksmem_sml_cnt, int *d_blksmem_lrg_cnt, int *d_blksmem_dns_cnt, 
...
// small : 33 - 64
    ...
    stir_spgemm_step4_cuda_kernel_smem_v3<SMEM_SML_TH,64,4><<< num_blocks, num_threads >>>
                             (d_blkrowptrA, d_blkcolidxA, d_nnzb_A, d_blkcsr_Val_A, d_blkcsr_Col_A, d_blkcsr_Ptr_A,
                              blkmA, blknA, numblkA, nnzA, 
                              d_blkcolptrB, d_blkrowidxB, d_nnzb_B, d_blkcsr_Val_B, d_blkcsr_Col_B, d_blkcsr_Ptr_B,
                              blkmB, blknB, numblkB, nnzB, 
...
// large : 65 - 128
    ...
    stir_spgemm_step4_cuda_kernel_smem_v3<SMEM_LRG_TH,64,4><<< num_blocks, num_threads >>>
                             (d_blkrowptrA, d_blkcolidxA, d_nnzb_A, d_blkcsr_Val_A, d_blkcsr_Col_A, d_blkcsr_Ptr_A,
                              blkmA, blknA, numblkA, nnzA, 
                              d_blkcolptrB, d_blkrowidxB, d_nnzb_B, d_blkcsr_Val_B, d_blkcsr_Col_B, d_blkcsr_Ptr_B,
                              blkmB, blknB, numblkB, nnzB, 
...
// dns : 129 - dns
    ...
    stir_spgemm_step4_cuda_kernel_dns<64,8><<< num_blocks, num_threads >>>
                             (d_blkrowptrA, d_blkcolidxA, d_nnzb_A, d_blkcsr_Val_A, d_blkcsr_Col_A, d_blkcsr_Ptr_A,
                              blkmA, blknA, numblkA, nnzA, 
                              d_blkcolptrB, d_blkrowidxB, d_nnzb_B, d_blkcsr_Val_B, d_blkcsr_Col_B, d_blkcsr_Ptr_B,
                              blkmB, blknB, numblkB, nnzB, 
...
// small : 33 - 64
   // cudaDeviceSynchronize();
    ...
    {
     num_blocks = ceil((double)blksmem_sml_cnt/(double)WARP_PER_BLOCK);
    stir_spgemm_step4_cuda_kernel_smem_v3<SMEM_SML_TH,64,4><<< num_blocks, num_threads>>>//, 0, stream[1] >>>
                             (d_blkrowptrA, d_blkcolidxA, d_nnzb_A, d_blkcsr_Val_A, d_blkcsr_Col_A, d_blkcsr_Ptr_A,
                              blkmA, blknA, numblkA, nnzA, 
                              d_blkcolptrB, d_blkrowidxB, d_nnzb_B, d_blkcsr_Val_B, d_blkcsr_Col_B, d_blkcsr_Ptr_B,
                              blkmB, blknB, numblkB, nnzB, 
...
// dns : 129 - dns
   ...
   if (blksmem_tny_cnt)
   {
     num_threads = WARP_SIZE * WARP_PER_BLOCK;
     num_blocks = ceil((double)blksmem_dns_cnt/(double)WARP_PER_BLOCK);
    stir_spgemm_step4_cuda_kernel_dns<64,8><<< num_blocks, num_threads >>>//, 0, stream[3] >>>
                             (d_blkrowptrA, d_blkcolidxA, d_nnzb_A, d_blkcsr_Val_A, d_blkcsr_Col_A, d_blkcsr_Ptr_A,
                              blkmA, blknA, numblkA, nnzA, 
                              d_blkcolptrB, d_blkrowidxB, d_nnzb_B, d_blkcsr_Val_B, d_blkcsr_Col_B, d_blkcsr_Ptr_B,
                              blkmB, blknB, numblkB, nnzB, 
...
printf("CUDA numblkC = %i\n", numblkC);
    printf("CUDA nnzC = %i\n", nnzC);
printf("stir_spgemm_time = %4.2f ms, gflops = %4.2f\n", stir_spgemm_time, *gflops_stir);
...
*/
    ...
    nnzb_C = (int *)malloc((rowblock_ptr_C[rbnum_A] + 1) * sizeof (int)) ;
...
*/
    ...
    step3_cuda  (rowblock_ptr_A,blkcolIdx_A,rbnum_A,cbnum_A,numblkA, nnzA, nnzb_A,rowA,
            ...
            nnzb_C, numblkC, &nnzC, d_blksmem_tny_cnt, d_blksmem_sml_cnt, d_blksmem_lrg_cnt, d_blksmem_dns_cnt, 
